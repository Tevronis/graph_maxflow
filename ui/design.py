...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.loadBtn = QtWidgets.QPushButton(self.frame_top)
        self.loadBtn.setObjectName("loadBtn")
        self.gridLayout_4.addWidget(self.loadBtn, 0, 2, 2, 1)
        ...
        self.gridLayout_4.addLayout(self.verticalLayout_4, 0, 3, 2, 1)
        self.verticalLayout_5 = QtWidgets.QVBoxLayout()
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.editVertex = QtWidgets.QLineEdit(self.frame_top)
        self.editVertex.setMaximumSize(QtCore.QSize(30, 30))
        self.editVertex.setObjectName("editVertex")
        self.verticalLayout_5.addWidget(self.editVertex)
        self.editEdges = QtWidgets.QLineEdit(self.frame_top)
        self.editEdges.setMaximumSize(QtCore.QSize(30, 16777215))
        self.editEdges.setObjectName("editEdges")
        self.verticalLayout_5.addWidget(self.editEdges)
        self.gridLayout_4.addLayout(self.verticalLayout_5, 0, 4, 2, 1)
        self.generateBtn = QtWidgets.QPushButton(self.frame_top)
        self.generateBtn.setObjectName("generateBtn")
        self.gridLayout_4.addWidget(self.generateBtn, 0, 5, 2, 1)
