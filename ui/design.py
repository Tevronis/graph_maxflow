...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.editVertex.setMaximumSize(QtCore.QSize(30, 16777215))
        ...
        self.editEdges.setMaximumSize(QtCore.QSize(30, 30))
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "Режим генерации"))
        item = self.listWidget.item(4)
        item.setText(_translate("Dialog", "Режим считывания из файла"))
